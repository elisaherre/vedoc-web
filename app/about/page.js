  ...
  return (
    <div className="w-full bg-white px-6 lg:px-24 pt-28 md:pt-36">
      ...
      <section className='flex flex-col items-center pb-5'>
        <h3 className='text-xs md:text-lg font-medium leading-8'>Hello,</h3>
        <h2 className='font-roboto uppercase font-medium text-xl lg:text-5xl py-3 md:py-5 text-center'>We are Vedoc</h2>
        <p className='text-xs md:text-sm lg:text-xl leading-5 md:leading-7 text-center font-light'>Vedoc is not just an app, it&apos;s a commitment to empowering both mechanics and users.</p>
        <p className='pb-8 text-sm lg:text-xl leading-5 md:leading-7 text-center font-light'>Vedoc is  where automotive care is personalized, efficient, and trustworthy.</p>
        <div className='page-image'></div>
      </section>
      {/* About Us */}
      <section className='flex flex-col items-start'>
        <h3 className='text-xs md:text-lg font-medium leading-8'>About Us</h3>
        <h2 className='font-roboto uppercase font-medium text-xl md:text-xl lg:text-4xl py-5 md:py-8'>What Vedoc is all about and how we started</h2>
        ...
        <div className="mb-7">
          <h3 className='text-xs md:text-lg font-medium leading-8 md:pb-8'>Our Mission</h3>
        ...
        <div className="mb-10 md:mb-20">
          <h3 className='text-xs md:text-lg font-medium leading-8 md:pb-8'>Our Vision</h3>
          <div className="flex flex-col lg:flex-row g-10">
